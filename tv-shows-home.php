...
<body>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-12">
                        <div class="slider slider-for">
                            <!-- Slider Items -->
                            <div class="slider-item" style="background: url('images/background/asset-16.jpeg')">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="gen-movie-info">
                                                        ...
                                                        <p>Streamlab is a long established fact that a reader will be
                                                            ...
                                                            at its layout. The point of using Lorem Streamlab is that it
                                                            has a more-or-less normal distribution of Streamlab as
                                                            opposed Streamlab.</p>
                            ...
                            <div class="slider-item" style="background: url('images/background/asset-13.jpeg')">
                                <div class="gen-slick-slider h-100">
                                    <div class="gen-movie-contain h-100">
                                        <div class="container h-100">
                                            <div class="row align-items-center h-100">
                            ...
                            <div class="slider-item" style="background: url('images/background/asset-77.jpg')">
                                <div class="gen-slick-slider h-100">
                                    <div class="gen-movie-contain h-100">
                                        <div class="container h-100">
                                            <div class="row align-items-center h-100">
                            ...
                            <div class="slider-item" style="background: url('images/background/asset-37.jpeg')">
                                <div class="gen-slick-slider h-100">
                                    <div class="gen-movie-contain h-100">
                                        <div class="container h-100">
                                            <div class="row align-items-center h-100">
                        ...
                        <div class="slider slider-nav">
                            <div class="slider-nav-contain">
                                <div class="gen-nav-img">
                                    <img src="images/background/asset-16.jpeg" alt="steamlab-image">
                                </div>
                            ...
                            <div class="slider-nav-contain">
                                <div class="gen-nav-img">
                                    <img src="images/background/asset-37.jpeg" alt="streamlab-image">
                                </div>
                                <div class="movie-info">
                                    <h3>Against Beast</h3>
                                    <div class="gen-movie-meta-holder">
    ...
    <section class="pt-0 gen-section-padding-2">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <h3 class="gen-heading-title">All Time Hits</h3>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                    <div class="gen-movie-action">
                        <div class="gen-btn-container text-right">
                ...
                <div class="col-12">
                    <div class="gen-banner-movies">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="true" data-nav="false"
                            ...
                            <div class="item" style="background: url('images/background/asset-19.jpeg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                                                <div class="gen-movie-info">
                                                    <h3>Dream Of Dargons</h3>
                                                </div>
                                                <div class="gen-movie-meta-holder">
                                                    <ul>
                                                        <li>1 Season</li>
